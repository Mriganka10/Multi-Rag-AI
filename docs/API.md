...
```json
{
  ...
  "client_response": "Client-readable analysis appears here.",
  "data": {},
  "contexts": [],
  "artifacts": {},
  "llm": {
  ...
  "learned_context_path": "data/knowledge/learned/scn_20260606050000.txt",
...
Client-readable response generated by the LLM layer or the offline response builder.
...
Provider metadata for the generated client response.

### `learned_context_path`

Path to the learned RAG note created from the response when learning is enabled.
